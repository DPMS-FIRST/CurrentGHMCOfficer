class ApiConstants {
  ...
  static const String concessionaire_dashboard_endpoint ="GET_CONCESSIONER_DASHBOARD_LIST";

  static const String concessionaire_incharge_pickup_capturelist_endpoint ="GET_CONCESSIONER_PICKUP_CAPTURE_LIST";

  static const String concessionaire_incharge_pickup_capture_bind_plant_name_endpoint ="BIND_PLANT_NAME";

  static const String concessionaire_incharge_pickup_capture_vehicletypes ="GetVehicleTypes";

  static const String concessionaire_incharge_manual_closing_tickets_endpoint ="CONCESSIONER_MANUAL_CLOSING_TICKET_LIST";

  static const String crejection_ticketlist_endpoint ="CONCESSIONER_REJECTED_TICKETS_LIST";

  static const String c_incharge_ticketlist_endpoint ="GET_CONCESSIONER_TICKET_LIST";
  ...
  ///amoh
  static const String amoh_closed_ticket_list_endpoint = "AMOH_CLOSED_TICKETS_LIST";
  static const String amoh_close_amoh_closed_ticket_submit ="AMOH_CLOSE_AMOH_CLOSE_TICKET_SUBMIT";
  static const String consessioner_closed_tickets_list_endpoint ="AMOH_GET_CONCESSIONER_CLOSED_TICKETS_LIST";
  static const String request_estimation_endpoint ="GET_AMOH_REQUEST_ESTIMATION_BY_ID";
  ...
  static const String request_estimation_submit_endpoint ="AMOH_REQUEST_ESTIMATION_SUBMIT";
  static const String get_vehicle_type = "GetVehicleTypes";
  static const String consessioner_rejected_ticket_list_endpoint ="CONCESSIONER_REJECTED_TICKETS_LIST";
  static const String amoh_reassign_concessioner_rejected_tickets ="AMOH_REASSIGN_CONCESSIONER_REJECTED_TICKETS";
  ...
  static const String amoh_raise_request_forwar_to_next_ward ="FORWARDTO_NEXTWARD";

  static const String amoh_raise_raise_request_submit ="AMOH_RAISE_GRIEVANCE_SUBMIT";

  static const String amoh_closed_ticket_submit_endpoint ="AMOH_CLOSE_AMOH_CLOSE_TICKET_SUBMIT";

  static const String amoh_concessioner_closed_ticket_submit_endpoint ="AMOH_CLOSE_CONCESSIONER_CLOSE_TICKET_SUBMIT";
  static const String amoh_raise_request_demographics_endpoint ="GET_DEMOGRAPHICS";

  static const String concessionaire_incharge_pickup_capture_details_submit = "CONCESSIONER_PICKUP_CAPTURE_SUBMIT";

  static const String c_incharge_manual_closing_tickets_submit ="CONCESSIONER_MANUAL_CLOSING_TICKET_SUBMIT";

   static const String amoh_c_close_ticket_submit ="AMOH_CLOSE_CONCESSIONER_CLOSE_TICKET_SUBMIT";
